Creating summary for _OutputIterator std::__fill_n_a(_OutputIterator, _Size, const _Tp&, std::random_access_iterator_tag) [with _OutputIterator = int*; _Size = long unsigned int; _Tp = int]/5500:
  Descriptor for parameter 0 __firstD.234243
    not a candidate
  Descriptor for parameter 1 __nD.234244
    not a candidate
  Descriptor for parameter 2 __valueD.234245
    by_ref with 0 pass throughs
        * Access to offset: 0, size: 32, type: const int, alias_ptr_type: const int &, nonarg: 1, reverse: 0
----------------------------------------
  Descriptor for parameter 0 __firstD.234243
  ...
  Descriptor for parameter 1 __nD.234244
    not a candidate for splitting
  Descriptor for parameter 2 __valueD.234245
    param_size_limit: 16, size_reached: 4, by_ref
    * Access to unit offset: 0, unit size: 4, type: const int, alias_ptr_type: const int &, certain


Creating summary for (static initializers for rc.cpp)/5461:


Creating summary for void __static_initialization_and_destruction_0(int, int)/5238:
  Descriptor for parameter 0 __initialize_pD.233259
    not a candidate for splitting
  Descriptor for parameter 1 __priorityD.233260
    not a candidate for splitting


Creating summary for std::vector<_Tp, _Alloc>::vector(const std::vector<_Tp, _Alloc>&) [with _Tp = int; _Alloc = std::allocator<int>]/4980:
  Descriptor for parameter 0 thisD.182698
    not a candidate for splitting
  Descriptor for parameter 1 __xD.182699
    not a candidate for splitting


Creating summary for _Tp* __gnu_cxx::new_allocator<_Tp>::allocate(__gnu_cxx::new_allocator<_Tp>::size_type, const void*) [with _Tp = std::vector<int>]/4913:
  Descriptor for parameter 0 thisD.212789
    unused with 0 call_uses
    by_ref with 0 pass throughs
  Descriptor for parameter 1 __nD.232046
    not a candidate
  Descriptor for parameter 2 D.232047
    unused with 0 call_uses
    not a candidate
----------------------------------------
  Descriptor for parameter 0 thisD.212789
    (locally) unused
    param_size_limit: 16, size_reached: 0, by_ref
  Descriptor for parameter 1 __nD.232046
    not a candidate for splitting
  Descriptor for parameter 2 D.232047
    (locally) unused
...
Creating summary for _Tp* __gnu_cxx::new_allocator<_Tp>::allocate(__gnu_cxx::new_allocator<_Tp>::size_type, const void*) [with _Tp = int]/4910:
  Descriptor for parameter 0 thisD.181740
    unused with 0 call_uses
    by_ref with 0 pass throughs
  Descriptor for parameter 1 __nD.231994
    not a candidate
  Descriptor for parameter 2 D.231995
    unused with 0 call_uses
    not a candidate
----------------------------------------
  Descriptor for parameter 0 thisD.181740
...
Creating summary for static _ForwardIterator std::__uninitialized_fill_n<_TrivialValueType>::__uninit_fill_n(_ForwardIterator, _Size, const _Tp&) [with _ForwardIterator = std::vector<int>*; _Size = long unsigned int; _Tp = std::vector<int>; bool _TrivialValueType = false]/4823:
  Descriptor for parameter 0 __firstD.231373
    not a candidate
  Descriptor for parameter 1 __nD.231374
    not a candidate
  Descriptor for parameter 2 __xD.231375
...
Creating summary for void std::_Vector_base<_Tp, _Alloc>::_M_create_storage(std::size_t) [with _Tp = std::vector<int>; _Alloc = std::allocator<std::vector<int> >]/4600:
  Descriptor for parameter 0 thisD.213141
    not a candidate for splitting
  Descriptor for parameter 1 __nD.227692
    not a candidate for splitting


Creating summary for void std::_Vector_base<_Tp, _Alloc>::_M_create_storage(std::size_t) [with _Tp = int; _Alloc = std::allocator<int>]/4588:
  Descriptor for parameter 0 thisD.182092
    not a candidate for splitting
  Descriptor for parameter 1 __nD.227477
    not a candidate for splitting


Creating summary for std::_Vector_base<_Tp, _Alloc>::~_Vector_base() [with _Tp = std::vector<int>; _Alloc = std::allocator<std::vector<int> >]/4337:
  Descriptor for parameter 0 thisD.213240
    not a candidate for splitting


Creating summary for void std::vector<_Tp, _Alloc>::_M_fill_initialize(std::vector<_Tp, _Alloc>::size_type, const value_type&) [with _Tp = int; _Alloc = std::allocator<int>]/4320:
  Descriptor for parameter 0 thisD.182485
    not a candidate
  Descriptor for parameter 1 __nD.225749
    not a candidate
  Descriptor for parameter 2 __valueD.225750
    unused with 1 call_uses
    by_ref with 1 pass throughs
----------------------------------------
  Descriptor for parameter 0 thisD.182485
...
Creating summary for std::_Vector_base<_Tp, _Alloc>::~_Vector_base() [with _Tp = int; _Alloc = std::allocator<int>]/4318:
  Descriptor for parameter 0 thisD.182191
    not a candidate for splitting


Creating summary for std::vector<_Tp, _Alloc>::~vector() [with _Tp = std::vector<int>; _Alloc = std::allocator<std::vector<int> >]/3926:
  Descriptor for parameter 0 thisD.213782
    not a candidate for splitting


Creating summary for std::vector<_Tp, _Alloc>::vector(std::vector<_Tp, _Alloc>::size_type, const value_type&, const allocator_type&) [with _Tp = std::vector<int>; _Alloc = std::allocator<std::vector<int> >]/3923:
  Descriptor for parameter 0 thisD.213756
    not a candidate
  Descriptor for parameter 1 __nD.213757
    not a candidate
  Descriptor for parameter 2 __valueD.213758
    unused with 1 call_uses
    by_ref with 1 pass throughs
  Descriptor for parameter 3 __aD.213759
    unused with 0 call_uses
    by_ref with 0 pass throughs
----------------------------------------
  Descriptor for parameter 0 thisD.213756
...
Creating summary for std::vector<_Tp, _Alloc>::vector(std::vector<_Tp, _Alloc>::size_type, const value_type&, const allocator_type&) [with _Tp = int; _Alloc = std::allocator<int>]/3911:
  Descriptor for parameter 0 thisD.182706
    not a candidate
  Descriptor for parameter 1 __nD.182707
    not a candidate
  Descriptor for parameter 2 __valueD.182708
    unused with 1 call_uses
    by_ref with 1 pass throughs
  Descriptor for parameter 3 __aD.182709
    unused with 0 call_uses
    by_ref with 0 pass throughs
----------------------------------------
  Descriptor for parameter 0 thisD.182706
...
Creating summary for int main()/3228:



========== IPA-SRA IPA stage ==========

Summary for node __static_initialization_and_destruction_0.constprop/5531:
  Descriptor for parameter 0:
    not a candidate for splitting
  Descriptor for parameter 1:
    not a candidate for splitting

  Summary for edge __static_initialization_and_destruction_0.constprop/5531->std::ios_base::Init::Init()/5479:
    return value ignored
  Summary for edge __static_initialization_and_destruction_0.constprop/5531->int __cxxabiv1::__cxa_atexit(void (*)(void*), void*, void*)/5480:
    return value ignored

Summary for node _OutputIterator std::__fill_n_a(_OutputIterator, _Size, const _Tp&, std::random_access_iterator_tag) [with _OutputIterator = int*; _Size = long unsigned int; _Tp = int]/5500:
  Returns value
  Descriptor for parameter 0:
    not a candidate for splitting
  Descriptor for parameter 1:
...
Summary for node (static initializers for rc.cpp)/5461:
  No parameter information. 

  Summary for edge (static initializers for rc.cpp)/5461->__static_initialization_and_destruction_0.constprop/5531:
    return value ignored

Summary for node std::vector<_Tp, _Alloc>::vector(const std::vector<_Tp, _Alloc>&) [with _Tp = int; _Alloc = std::allocator<int>]/4980:
  Descriptor for parameter 0:
    not a candidate for splitting
  Descriptor for parameter 1:
    not a candidate for splitting

  Summary for edge std::vector<_Tp, _Alloc>::vector(const std::vector<_Tp, _Alloc>&) [with _Tp = int; _Alloc = std::allocator<int>]/4980->void* __builtin_memmove(void*, const void*, long unsigned int)/5477:
    return value ignored
  Summary for edge std::vector<_Tp, _Alloc>::vector(const std::vector<_Tp, _Alloc>&) [with _Tp = int; _Alloc = std::allocator<int>]/4980->void std::_Vector_base<_Tp, _Alloc>::_M_create_storage(std::size_t) [with _Tp = int; _Alloc = std::allocator<int>]/4588:
    return value ignored

Summary for node _Tp* __gnu_cxx::new_allocator<_Tp>::allocate(__gnu_cxx::new_allocator<_Tp>::size_type, const void*) [with _Tp = std::vector<int>]/4913:
  Returns value
  Descriptor for parameter 0:
    (locally) unused
    param_size_limit: 16, size_reached: 0, by_ref
  ...
  Summary for edge _Tp* __gnu_cxx::new_allocator<_Tp>::allocate(__gnu_cxx::new_allocator<_Tp>::size_type, const void*) [with _Tp = std::vector<int>]/4913->void* operator new(std::size_t)/5471:
    return value used only to compute caller return value
  Summary for edge _Tp* __gnu_cxx::new_allocator<_Tp>::allocate(__gnu_cxx::new_allocator<_Tp>::size_type, const void*) [with _Tp = std::vector<int>]/4913->void std::__throw_bad_alloc()/5470:
    return value ignored
  Summary for edge _Tp* __gnu_cxx::new_allocator<_Tp>::allocate(__gnu_cxx::new_allocator<_Tp>::size_type, const void*) [with _Tp = std::vector<int>]/4913->void std::__throw_bad_array_new_length()/5469:
    return value ignored
  Summary for edge _Tp* __gnu_cxx::new_allocator<_Tp>::allocate(__gnu_cxx::new_allocator<_Tp>::size_type, const void*) [with _Tp = std::vector<int>]/4913->long int __builtin_expect(long int, long int)/5468:
    Parameter 0:
      Scalar param sources: 1
    Parameter 1:

Summary for node _Tp* __gnu_cxx::new_allocator<_Tp>::allocate(__gnu_cxx::new_allocator<_Tp>::size_type, const void*) [with _Tp = int]/4910:
  Returns value
  Descriptor for parameter 0:
    (locally) unused
    param_size_limit: 16, size_reached: 0, by_ref
  ...
  Summary for edge _Tp* __gnu_cxx::new_allocator<_Tp>::allocate(__gnu_cxx::new_allocator<_Tp>::size_type, const void*) [with _Tp = int]/4910->void* operator new(std::size_t)/5471:
    return value used only to compute caller return value
  Summary for edge _Tp* __gnu_cxx::new_allocator<_Tp>::allocate(__gnu_cxx::new_allocator<_Tp>::size_type, const void*) [with _Tp = int]/4910->void std::__throw_bad_alloc()/5470:
    return value ignored
  Summary for edge _Tp* __gnu_cxx::new_allocator<_Tp>::allocate(__gnu_cxx::new_allocator<_Tp>::size_type, const void*) [with _Tp = int]/4910->void std::__throw_bad_array_new_length()/5469:
    return value ignored
  Summary for edge _Tp* __gnu_cxx::new_allocator<_Tp>::allocate(__gnu_cxx::new_allocator<_Tp>::size_type, const void*) [with _Tp = int]/4910->long int __builtin_expect(long int, long int)/5468:
    Parameter 0:
      Scalar param sources: 1
    Parameter 1:

Summary for node static _ForwardIterator std::__uninitialized_fill_n<_TrivialValueType>::__uninit_fill_n(_ForwardIterator, _Size, const _Tp&) [with _ForwardIterator = std::vector<int>*; _Size = long unsigned int; _Tp = std::vector<int>; bool _TrivialValueType = false]/4823:
  Returns value
  Descriptor for parameter 0:
    not a candidate for splitting
  Descriptor for parameter 1:
  ...
  Summary for edge static _ForwardIterator std::__uninitialized_fill_n<_TrivialValueType>::__uninit_fill_n(_ForwardIterator, _Size, const _Tp&) [with _ForwardIterator = std::vector<int>*; _Size = long unsigned int; _Tp = std::vector<int>; bool _TrivialValueType = false]/4823->void __cxa_end_catch()/5476:
    return value ignored
  Summary for edge static _ForwardIterator std::__uninitialized_fill_n<_TrivialValueType>::__uninit_fill_n(_ForwardIterator, _Size, const _Tp&) [with _ForwardIterator = std::vector<int>*; _Size = long unsigned int; _Tp = std::vector<int>; bool _TrivialValueType = false]/4823->void __cxa_rethrow()/5475:
    return value ignored
  Summary for edge static _ForwardIterator std::__uninitialized_fill_n<_TrivialValueType>::__uninit_fill_n(_ForwardIterator, _Size, const _Tp&) [with _ForwardIterator = std::vector<int>*; _Size = long unsigned int; _Tp = std::vector<int>; bool _TrivialValueType = false]/4823->std::_Vector_base<_Tp, _Alloc>::~_Vector_base() [with _Tp = int; _Alloc = std::allocator<int>]/4318:
    return value ignored
    Parameter 0:
  Summary for edge static _ForwardIterator std::__uninitialized_fill_n<_TrivialValueType>::__uninit_fill_n(_ForwardIterator, _Size, const _Tp&) [with _ForwardIterator = std::vector<int>*; _Size = long unsigned int; _Tp = std::vector<int>; bool _TrivialValueType = false]/4823->void* __cxa_begin_catch(void*)/5474:
    return value ignored
    Parameter 0:
  Summary for edge static _ForwardIterator std::__uninitialized_fill_n<_TrivialValueType>::__uninit_fill_n(_ForwardIterator, _Size, const _Tp&) [with _ForwardIterator = std::vector<int>*; _Size = long unsigned int; _Tp = std::vector<int>; bool _TrivialValueType = false]/4823->void* __builtin_eh_pointer(int)/5473:
    Parameter 0:
...
Summary for node void std::_Vector_base<_Tp, _Alloc>::_M_create_storage(std::size_t) [with _Tp = std::vector<int>; _Alloc = std::allocator<std::vector<int> >]/4600:
  Descriptor for parameter 0:
    not a candidate for splitting
  Descriptor for parameter 1:
    not a candidate for splitting

  Summary for edge void std::_Vector_base<_Tp, _Alloc>::_M_create_storage(std::size_t) [with _Tp = std::vector<int>; _Alloc = std::allocator<std::vector<int> >]/4600->_Tp* __gnu_cxx::new_allocator<_Tp>::allocate(__gnu_cxx::new_allocator<_Tp>::size_type, const void*) [with _Tp = std::vector<int>]/4913:
    Parameter 0:
    Parameter 1:
      Scalar param sources: 1
    Parameter 2:

Summary for node void std::_Vector_base<_Tp, _Alloc>::_M_create_storage(std::size_t) [with _Tp = int; _Alloc = std::allocator<int>]/4588:
  Descriptor for parameter 0:
    not a candidate for splitting
  Descriptor for parameter 1:
    not a candidate for splitting

  Summary for edge void std::_Vector_base<_Tp, _Alloc>::_M_create_storage(std::size_t) [with _Tp = int; _Alloc = std::allocator<int>]/4588->_Tp* __gnu_cxx::new_allocator<_Tp>::allocate(__gnu_cxx::new_allocator<_Tp>::size_type, const void*) [with _Tp = int]/4910:
    Parameter 0:
    Parameter 1:
      Scalar param sources: 1
    Parameter 2:

Summary for node std::_Vector_base<_Tp, _Alloc>::~_Vector_base() [with _Tp = std::vector<int>; _Alloc = std::allocator<std::vector<int> >]/4337:
  Descriptor for parameter 0:
    not a candidate for splitting

  Summary for edge std::_Vector_base<_Tp, _Alloc>::~_Vector_base() [with _Tp = std::vector<int>; _Alloc = std::allocator<std::vector<int> >]/4337->void operator delete(void*, std::size_t)/5472:
    return value ignored

Summary for node void std::vector<_Tp, _Alloc>::_M_fill_initialize(std::vector<_Tp, _Alloc>::size_type, const value_type&) [with _Tp = int; _Alloc = std::allocator<int>]/4320:
  Descriptor for parameter 0:
    not a candidate for splitting
  Descriptor for parameter 1:
    not a candidate for splitting
  ...
  Summary for edge void std::vector<_Tp, _Alloc>::_M_fill_initialize(std::vector<_Tp, _Alloc>::size_type, const value_type&) [with _Tp = int; _Alloc = std::allocator<int>]/4320->_OutputIterator std::__fill_n_a(_OutputIterator, _Size, const _Tp&, std::random_access_iterator_tag) [with _OutputIterator = int*; _Size = long unsigned int; _Tp = int]/5500:
...
Summary for node std::_Vector_base<_Tp, _Alloc>::~_Vector_base() [with _Tp = int; _Alloc = std::allocator<int>]/4318:
  Descriptor for parameter 0:
    not a candidate for splitting

  Summary for edge std::_Vector_base<_Tp, _Alloc>::~_Vector_base() [with _Tp = int; _Alloc = std::allocator<int>]/4318->void operator delete(void*, std::size_t)/5472:
    return value ignored

Summary for node std::vector<_Tp, _Alloc>::~vector() [with _Tp = std::vector<int>; _Alloc = std::allocator<std::vector<int> >]/3926:
  Descriptor for parameter 0:
    not a candidate for splitting

  Summary for edge std::vector<_Tp, _Alloc>::~vector() [with _Tp = std::vector<int>; _Alloc = std::allocator<std::vector<int> >]/3926->std::_Vector_base<_Tp, _Alloc>::~_Vector_base() [with _Tp = std::vector<int>; _Alloc = std::allocator<std::vector<int> >]/4337:
    return value ignored
  Summary for edge std::vector<_Tp, _Alloc>::~vector() [with _Tp = std::vector<int>; _Alloc = std::allocator<std::vector<int> >]/3926->std::_Vector_base<_Tp, _Alloc>::~_Vector_base() [with _Tp = int; _Alloc = std::allocator<int>]/4318:
    return value ignored

Summary for node std::vector<_Tp, _Alloc>::vector(std::vector<_Tp, _Alloc>::size_type, const value_type&, const allocator_type&) [with _Tp = std::vector<int>; _Alloc = std::allocator<std::vector<int> >]/3923:
  Descriptor for parameter 0:
    not a candidate for splitting
  Descriptor for parameter 1:
    not a candidate for splitting
  ...
  Summary for edge std::vector<_Tp, _Alloc>::vector(std::vector<_Tp, _Alloc>::size_type, const value_type&, const allocator_type&) [with _Tp = std::vector<int>; _Alloc = std::allocator<std::vector<int> >]/3923->std::_Vector_base<_Tp, _Alloc>::~_Vector_base() [with _Tp = std::vector<int>; _Alloc = std::allocator<std::vector<int> >]/4337:
    return value ignored
    Parameter 0:
  Summary for edge std::vector<_Tp, _Alloc>::vector(std::vector<_Tp, _Alloc>::size_type, const value_type&, const allocator_type&) [with _Tp = std::vector<int>; _Alloc = std::allocator<std::vector<int> >]/3923->static _ForwardIterator std::__uninitialized_fill_n<_TrivialValueType>::__uninit_fill_n(_ForwardIterator, _Size, const _Tp&) [with _ForwardIterator = std::vector<int>*; _Size = long unsigned int; _Tp = std::vector<int>; bool _TrivialValueType = false]/4823:
    Parameter 0:
    Parameter 1:
    Parameter 2:
      Scalar param sources: 2
      Pointer pass through from the param given above, safe_to_import_accesses: 0
  Summary for edge std::vector<_Tp, _Alloc>::vector(std::vector<_Tp, _Alloc>::size_type, const value_type&, const allocator_type&) [with _Tp = std::vector<int>; _Alloc = std::allocator<std::vector<int> >]/3923->void std::_Vector_base<_Tp, _Alloc>::_M_create_storage(std::size_t) [with _Tp = std::vector<int>; _Alloc = std::allocator<std::vector<int> >]/4600:
    return value ignored
    Parameter 0:
    Parameter 1:
      Scalar param sources: 1
  Summary for edge std::vector<_Tp, _Alloc>::vector(std::vector<_Tp, _Alloc>::size_type, const value_type&, const allocator_type&) [with _Tp = std::vector<int>; _Alloc = std::allocator<std::vector<int> >]/3923->void std::__throw_length_error(const char*)/5467:
    return value ignored
    Parameter 0:

Summary for node std::vector<_Tp, _Alloc>::vector(std::vector<_Tp, _Alloc>::size_type, const value_type&, const allocator_type&) [with _Tp = int; _Alloc = std::allocator<int>]/3911:
  Descriptor for parameter 0:
    not a candidate for splitting
  Descriptor for parameter 1:
    not a candidate for splitting
  ...
  Summary for edge std::vector<_Tp, _Alloc>::vector(std::vector<_Tp, _Alloc>::size_type, const value_type&, const allocator_type&) [with _Tp = int; _Alloc = std::allocator<int>]/3911->void std::vector<_Tp, _Alloc>::_M_fill_initialize(std::vector<_Tp, _Alloc>::size_type, const value_type&) [with _Tp = int; _Alloc = std::allocator<int>]/4320:
    return value ignored
    Parameter 0:
    Parameter 1:
    Parameter 2:
      Scalar param sources: 2
      Pointer pass through from the param given above, safe_to_import_accesses: 0
  Summary for edge std::vector<_Tp, _Alloc>::vector(std::vector<_Tp, _Alloc>::size_type, const value_type&, const allocator_type&) [with _Tp = int; _Alloc = std::allocator<int>]/3911->void std::_Vector_base<_Tp, _Alloc>::_M_create_storage(std::size_t) [with _Tp = int; _Alloc = std::allocator<int>]/4588:
    return value ignored
    Parameter 0:
    Parameter 1:
      Scalar param sources: 1
  Summary for edge std::vector<_Tp, _Alloc>::vector(std::vector<_Tp, _Alloc>::size_type, const value_type&, const allocator_type&) [with _Tp = int; _Alloc = std::allocator<int>]/3911->void std::__throw_length_error(const char*)/5467:
    return value ignored
    Parameter 0:

Summary for node int main()/3228:
  Returns value
  No parameter information. 

  Summary for edge int main()/3228->std::vector<_Tp, _Alloc>::~vector() [with _Tp = std::vector<int>; _Alloc = std::allocator<std::vector<int> >]/3927:
    return value ignored
  Summary for edge int main()/3228->std::_Vector_base<_Tp, _Alloc>::~_Vector_base() [with _Tp = int; _Alloc = std::allocator<int>]/4318:
    return value ignored
  Summary for edge int main()/3228->std::vector<_Tp, _Alloc>::~vector() [with _Tp = std::vector<int>; _Alloc = std::allocator<std::vector<int> >]/3927:
    return value ignored
  Summary for edge int main()/3228->std::basic_ostream<_CharT, _Traits>& std::__ostream_insert(std::basic_ostream<_CharT, _Traits>&, const _CharT*, std::streamsize) [with _CharT = char; _Traits = std::char_traits<char>]/5478:
    return value ignored
  Summary for edge int main()/3228->std::basic_ostream<_CharT, _Traits>& std::basic_ostream<_CharT, _Traits>::operator<<(int) [with _CharT = char; _Traits = std::char_traits<char>]/5464:
  Summary for edge int main()/3228->std::_Vector_base<_Tp, _Alloc>::~_Vector_base() [with _Tp = int; _Alloc = std::allocator<int>]/4318:
    return value ignored
  Summary for edge int main()/3228->std::vector<_Tp, _Alloc>::vector(std::vector<_Tp, _Alloc>::size_type, const value_type&, const allocator_type&) [with _Tp = std::vector<int>; _Alloc = std::allocator<std::vector<int> >]/3924:
    return value ignored
  Summary for edge int main()/3228->std::vector<_Tp, _Alloc>::vector(std::vector<_Tp, _Alloc>::size_type, const value_type&, const allocator_type&) [with _Tp = int; _Alloc = std::allocator<int>]/3912:
    return value ignored
  Summary for edge int main()/3228->std::basic_istream<_CharT, _Traits>& std::basic_istream<_CharT, _Traits>::operator>>(int&) [with _CharT = char; _Traits = std::char_traits<char>]/5462:
    return value ignored
  Summary for edge int main()/3228->std::basic_istream<_CharT, _Traits>& std::basic_istream<_CharT, _Traits>::operator>>(int&) [with _CharT = char; _Traits = std::char_traits<char>]/5462:


Function std::_Vector_base<_Tp, _Alloc>::~_Vector_base() [with _Tp = std::vector<int>; _Alloc = std::allocator<std::vector<int> >]/4337 disqualified because it cannot be made local.
Function std::_Vector_base<_Tp, _Alloc>::~_Vector_base() [with _Tp = int; _Alloc = std::allocator<int>]/4318 disqualified because it cannot be made local.
Function std::vector<_Tp, _Alloc>::~vector() [with _Tp = std::vector<int>; _Alloc = std::allocator<std::vector<int> >]/3926 disqualified because it cannot be made local.
Function std::vector<_Tp, _Alloc>::vector(const std::vector<_Tp, _Alloc>&) [with _Tp = int; _Alloc = std::allocator<int>]/4980 disqualified because it cannot be made local.
Function std::vector<_Tp, _Alloc>::vector(std::vector<_Tp, _Alloc>::size_type, const value_type&, const allocator_type&) [with _Tp = std::vector<int>; _Alloc = std::allocator<std::vector<int> >]/3923 disqualified because it cannot be made local.
Function std::vector<_Tp, _Alloc>::vector(std::vector<_Tp, _Alloc>::size_type, const value_type&, const allocator_type&) [with _Tp = int; _Alloc = std::allocator<int>]/3911 disqualified because it cannot be made local.
Function int main()/3228 disqualified because it cannot be made local.

========== IPA-SRA decisions ==========

Evaluating analysis results for _OutputIterator std::__fill_n_a(_OutputIterator, _Size, const _Tp&, std::random_access_iterator_tag) [with _OutputIterator = int*; _Size = long unsigned int; _Tp = int]/5500
  Will split parameter 2
    - component at byte offset 0, size 4
  Created new node _OutputIterator std::__fill_n_a(_OutputIterator, _Size, const _Tp&, std::random_access_iterator_tag) [with _OutputIterator = int*; _Size = long unsigned int; _Tp = int]/5532

Evaluating analysis results for _Tp* __gnu_cxx::new_allocator<_Tp>::allocate(__gnu_cxx::new_allocator<_Tp>::size_type, const void*) [with _Tp = std::vector<int>]/4913
  Will remove parameter 0
  Will remove parameter 2
  Created new node allocate.isra/5533

Evaluating analysis results for _Tp* __gnu_cxx::new_allocator<_Tp>::allocate(__gnu_cxx::new_allocator<_Tp>::size_type, const void*) [with _Tp = int]/4910
  Will remove parameter 0
  Will remove parameter 2
  Created new node allocate.isra/5534

========== IPA SRA IPA analysis done ==========


Reclaiming functions: _OutputIterator std::__fill_n_a(_OutputIterator, _Size, const _Tp&, std::random_access_iterator_tag) [with _OutputIterator = int*; _Size = long unsigned int; _Tp = int]/5500 _Tp* __gnu_cxx::new_allocator<_Tp>::allocate(__gnu_cxx::new_allocator<_Tp>::size_type, const void*) [with _Tp = std::vector<int>]/4913 _Tp* __gnu_cxx::new_allocator<_Tp>::allocate(__gnu_cxx::new_allocator<_Tp>::size_type, const void*) [with _Tp = int]/4910
Reclaiming variables:
Clearing address taken flags:
Symbol table:

_ZN9__gnu_cxx13new_allocatorIiE8allocateEmPKv.isra.0/5534 (allocate.isra) @0x7f1148065ee0
  Type: function definition analyzed
  Visibility: visibility_specified
  References: 
  Referring: 
  Clone of _ZN9__gnu_cxx13new_allocatorIiE8allocateEmPKv/4910
  Availability: local
  Function flags: count:1073741824 (estimated locally) local decl_is_malloc
  ...
  Calls: __builtin_expect/5468 (1073741824 (estimated locally),1.00 per call) _ZSt28__throw_bad_array_new_lengthv/5469 (53687092 (estimated locally),0.05 per call) (can throw external) _ZSt17__throw_bad_allocv/5470 (53687092 (estimated locally),0.05 per call) (can throw external) _Znwm/5471 (966367641 (estimated locally),0.90 per call) (can throw external) 
_ZN9__gnu_cxx13new_allocatorISt6vectorIiSaIiEEE8allocateEmPKv.isra.0/5533 (allocate.isra) @0x7f114803d440
  Type: function definition analyzed
  Visibility: visibility_specified
  References: 
  Referring: 
  Clone of _ZN9__gnu_cxx13new_allocatorISt6vectorIiSaIiEEE8allocateEmPKv/4913
  Availability: local
  Function flags: count:1073741824 (estimated locally) local decl_is_malloc
  ...
  Calls: __builtin_expect/5468 (1073741824 (estimated locally),1.00 per call) _ZSt28__throw_bad_array_new_lengthv/5469 (53687092 (estimated locally),0.05 per call) (can throw external) _ZSt17__throw_bad_allocv/5470 (53687092 (estimated locally),0.05 per call) (can throw external) _Znwm/5471 (966367641 (estimated locally),0.90 per call) (can throw external) 
_ZSt10__fill_n_aIPimiET_S1_T0_RKT1_St26random_access_iterator_tag.part.0.isra.0/5532 (_OutputIterator std::__fill_n_a(_OutputIterator, _Size, const _Tp&, std::random_access_iterator_tag) [with _OutputIterator = int*; _Size = long unsigned int; _Tp = int]) @0x7f114803d330
  Type: function definition analyzed
  Visibility: artificial
  References: 
  Referring: 
  Clone of _ZSt10__fill_n_aIPimiET_S1_T0_RKT1_St26random_access_iterator_tag.part.0/5500
  Availability: local
  Function flags: count:118111600 (estimated locally) local split_part
...
_ZSt10__fill_n_aIPimiET_S1_T0_RKT1_St26random_access_iterator_tag.part.0/5500 (_OutputIterator std::__fill_n_a(_OutputIterator, _Size, const _Tp&, std::random_access_iterator_tag) [with _OutputIterator = int*; _Size = long unsigned int; _Tp = int]) @0x7f114a088660
  ...
  Function flags: count:118111600 (estimated locally) body split_part
  Called by: 
  Calls: 
...
_Znwm/5471 (void* operator new(std::size_t)) @0x7f113fa40550
  ...
  Called by: _ZN9__gnu_cxx13new_allocatorIiE8allocateEmPKv.isra.0/5534 (966367641 (estimated locally),0.90 per call) (can throw external) _ZN9__gnu_cxx13new_allocatorISt6vectorIiSaIiEEE8allocateEmPKv.isra.0/5533 (966367641 (estimated locally),0.90 per call) (can throw external) 
  Calls: 
_ZSt17__throw_bad_allocv/5470 (void std::__throw_bad_alloc()) @0x7f113fa40440
  ...
  Availability: not_available
  Function flags:
  Called by: _ZN9__gnu_cxx13new_allocatorIiE8allocateEmPKv.isra.0/5534 (53687092 (estimated locally),0.05 per call) (can throw external) _ZN9__gnu_cxx13new_allocatorISt6vectorIiSaIiEEE8allocateEmPKv.isra.0/5533 (53687092 (estimated locally),0.05 per call) (can throw external) 
  Calls: 
...
__builtin_expect/5468 (long int __builtin_expect(long int, long int)) @0x7f113fa40220
  ...
  Availability: not_available
  Function flags:
  Called by: _ZN9__gnu_cxx13new_allocatorIiE8allocateEmPKv.isra.0/5534 (1073741824 (estimated locally),1.00 per call) _ZN9__gnu_cxx13new_allocatorISt6vectorIiSaIiEEE8allocateEmPKv.isra.0/5533 (1073741824 (estimated locally),1.00 per call) 
  Calls: 
...
_ZNSt12_Vector_baseISt6vectorIiSaIiEESaIS2_EE17_M_create_storageEm/4600 (void std::_Vector_base<_Tp, _Alloc>::_M_create_storage(std::size_t) [with _Tp = std::vector<int>; _Alloc = std::allocator<std::vector<int> >]) @0x7f11401a2220
  ...
  Calls: _ZN9__gnu_cxx13new_allocatorISt6vectorIiSaIiEEE8allocateEmPKv.isra.0/5533 (587014657 (estimated locally),0.55 per call) (can throw external) 
_ZNSt12_Vector_baseIiSaIiEE17_M_create_storageEm/4588 (void std::_Vector_base<_Tp, _Alloc>::_M_create_storage(std::size_t) [with _Tp = int; _Alloc = std::allocator<int>]) @0x7f114017a550
  ...
  Calls: _ZN9__gnu_cxx13new_allocatorIiE8allocateEmPKv.isra.0/5534 (587014657 (estimated locally),0.55 per call) (can throw external) 
...
_ZNSt6vectorIiSaIiEE18_M_fill_initializeEmRKi/4320 (void std::vector<_Tp, _Alloc>::_M_fill_initialize(std::vector<_Tp, _Alloc>::size_type, const value_type&) [with _Tp = int; _Alloc = std::allocator<int>]) @0x7f11403df990
  ...
  Calls: _ZSt10__fill_n_aIPimiET_S1_T0_RKT1_St26random_access_iterator_tag.part.0.isra.0/5532 (708669601 (estimated locally),0.66 per call) 
